      ...
      <div className="container mx-auto px-4">
        <motion.div className="mb-12 text-center sm:mb-16" variants={itemVariants}>
          ...
          <p className="mx-auto max-w-4xl px-4 text-sm leading-relaxed text-gray-600 sm:text-base lg:text-lg">
            At our company, we leverage scalable and cutting-edge frameworks and technologies to
        ...
        <div className="mx-auto max-w-7xl">
          <motion.div
            className="mb-8 flex flex-wrap justify-center gap-3 sm:mb-12"
            variants={containerVariants}
          >
            {Object.keys(toolkitData).map((tab) => (
              ...
              >
                <Button
                  ...
                  className={`rounded-full px-5 py-2 text-sm font-medium transition-all duration-300 sm:text-base ${
                    activeTab === tab
                      ? "bg-customBg text-white shadow-lg hover:bg-customBg/80"
                      : "border-gray-300 text-gray-700 hover:border-customBg/80 hover:bg-gray-50 hover:text-customBg"
                  }`}
                >
                  {tab}
                </Button>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.2 }}>
                <Card className="w-full border-0 bg-thirdbg shadow-lg lg:max-w-[400px]">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-2xl font-bold text-customBg">{activeTab}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <motion.p
              ...
              <motion.div className="flex-1" variants={containerVariants}>
                <h4 className="mb-6 border-b border-gray-200 pb-2 text-lg font-semibold text-gray-900">
                  Technologies We Use
                </h4>
                <motion.div
                ...
                >
                  {toolkitData[activeTab].technologies.map((tech, index) => (
                    <motion.div key={tech.name} variants={techCardVariants} whileHover="hover">
                      <Card className="group relative transition-all duration-300 hover:border-green-300 hover:shadow-md">
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                ...
                                {tech.level === "Expert" && (
                                  <motion.span
                                    className="absolute right-2 top-2 w-fit rounded-full bg-green-100 px-2 py-0.5 text-xs text-green-800"
                                    initial={{ scale: 0 }}
                                    animate={{ scale: 1 }}
                                    transition={{
                                      type: "spring",
