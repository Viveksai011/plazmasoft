...
const differentCard = [
  {
    ...
    desc: "No confusing tech jargon. We explain everything in plain English on how it impacts your business.",
  },
  {
    id: 2,
    title: "Transparent Pricing ",
    icon: "https://res.cloudinary.com/dko4n7zoc/image/upload/v1758387390/1-3_jpnj5g.webp",
    desc: "Fixed-price projects with no hidden costs. You know exactly what you're paying for before we start.",
  },
  {
    id: 3,
    title: "Fast Response",
    icon: "https://res.cloudinary.com/dko4n7zoc/image/upload/v1758387390/1-2_epieby.webp",
    desc: "Questions answered within 4 hours during business days. Emergency support available 24/7.",
  },
  {
    id: 4,
    title: "Long-term",
    icon: "https://res.cloudinary.com/dko4n7zoc/image/upload/v1758387390/1-2_epieby.webp",
    desc: "We're not just vendors - we're your tech team. We grow with business adapt solutions as you scale.",
  },
];
const OurStory = {
  description:
  ...
  vision: {
    quote: "Technology shouldn't be frustrating it should be your business's best asset.",
    content:
